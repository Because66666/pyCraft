...
KNOWN_MINECRAFT_VERSION_RECORDS = [
    ...
    Version('1.20.3',                765,      True),
    Version('1.20.4',                765,      True),
    Version('1.20.5',                766,      True),
    Version('1.20.6',                766,      True),
    Version('1.21',                  767,      True),
    Version('1.21.1',                767,      True),
    Version('1.21.2',                768,      True),
    Version('1.21.3',                768,      True),
    Version('1.21.4',                769,      True),
    Version('1.21.5',                770,      True),
    Version('1.21.6',                771,      True),
    Version('1.21.7',                772,      True),
    Version('1.21.8',                772,      True),
