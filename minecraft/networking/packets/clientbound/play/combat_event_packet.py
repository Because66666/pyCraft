...
class EnterCombatEventPacket(SpecialisedCombatEventPacket):
    ...
    def get_id(context):
        return 0x43 if context.protocol_later_eq(775) else \
               0x41 if context.protocol_later_eq(773) else \
...
class EndCombatEventPacket(SpecialisedCombatEventPacket):
    ...
    def get_id(context):
        return 0x42 if context.protocol_later_eq(775) else \
               0x40 if context.protocol_later_eq(773) else \
...
class DeathCombatEventPacket(SpecialisedCombatEventPacket):
    @staticmethod
    def get_id(context):
        return 0x44 if context.protocol_later_eq(775) else \
               0x42 if context.protocol_later_eq(773) else \
